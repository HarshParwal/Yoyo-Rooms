...
<div class="container"> 
  <div class="row content">
    <div class="col-sm-12">
      <h1 id="font">About Me</h1><br>
      <h4> Name : Harsh Parwal </h4> <br>
      <h4> Registration number : 20BCE1929 </h4> <br>
      <h4> University : Vellore Institute of technology </h4> <br>
<h1 align="center"id="font">Project</h1><br>
<h4>I have made this project as a part of my digital assignment 2 submission. This project is based on PHP,HTML,JAVASCRIPT & MYSQL. Using this project a user can register himself and provide feedback. Backend and frontend both included.</h4>
    </div>
  </div><br><br>
...
<!--Map Close Here-->
        ...
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
         ...
         <div class="col-sm-2">
          <h4><b>Email-Id</b></h4>
              <b>harsh.parwal2020@vitstudent.ac.in</b>
        </div>
  </div><br><br>
</div>
</div>
